...
@Component({
  ...
  standalone: true,
  imports: [HerosectionComponent, DonationCTAComponent],
...
export class NosactionsComponent {
  ...
  textParent =
    'Rejoignez notre communauté de bénévoles et faites une différence dans la vie des autres. Que vous ayez quelques heures par semaine ou par mois, chaque geste compte et contribue à améliorer notre société.';
